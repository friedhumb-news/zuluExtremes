...
1. Assign the language code (i.e. 'en', 'de') as new repository secret at https://github.com/friedhumb-news/zuluExtremes/settings/secrets/actions  
   * Name:  **EXTREME_LANGUAGE**   
   * Value: **Your language code here**   
### EXTREME_GH_TOKEN  
:no_entry: EXTREME_GH_TOKEN **missing**:  
1. Assign the API key as new organization secret at https://github.com/organizations/friedhumb-news/settings/secrets/actions/new  
...
1. Goto https://github.com/orgs/friedhumb-news/people  
...
3. Assign the API key as (new?) organization secret or edit it at https://github.com/organizations/friedhumb-news/settings/secrets/actions  
   * Name:  **RAPIDAPI_KEY**   
   * Value: **Your key here**   
